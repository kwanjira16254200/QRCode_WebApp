-- รัน SQL นี้ใน Supabase SQL Editor เพื่อแก้ไข 403 Error
-- ไปที่: https://supabase.com/dashboard/project/pnozpuxxqcbnijragick/sql/new

-- ปิด Row Level Security (RLS)
...
-- สร้าง function สำหรับ analytics
